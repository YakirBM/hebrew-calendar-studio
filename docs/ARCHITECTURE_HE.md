...
במחשב תוצג מסילת הגדרות קבועה. במסך צר תוצג מגירת הגדרות בגובה מלא,
המודעת ל־safe areas. פתיחתה תנעל את גלילת הרקע, תמקד את המקלדת בתוך
המגירה, תתמוך ב־Escape ובכפתור סגירה גלוי, ותמקם את הפעולה הראשית באזור
האגודל. שדות כפולים יהפכו לעמודה יחידה כשאין רוחב מספיק.

התצוגה תתאים אוטומטית את רוחב הנייר הנבחר, כולל A3 אופקי. הגדלה ידנית
תאפשר גלילה מכוונת. כפתורי תצוגה, ייצוא, הגדרות ועריכת יום יעמדו בגודלי
המגע. עורך יום יהיה מסך מלא בטלפון צר ותיבת דו־שיח במסכים גדולים. תנועה
תשתמש רק ב־transform וב־opacity ותכבד העדפת reduced motion.
