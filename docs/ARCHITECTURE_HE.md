...
וב־680px ומטה למסך הגדרות מלא המודע ל־safe areas. במובייל ההגדרות
...
טלפון נפתח כברירת מחדל בתצוגת שבוע קריאה ולא בדף בן 22 שבועות ממוזער.
...
משאיר בהישג אגודל את ההגדרות, השבוע הקריא, הדף הפיזי והייצוא. בטלפון
אופקי שרוחבו 600px ומעלה מוצגים ימי השבוע בשתי עמודות.
