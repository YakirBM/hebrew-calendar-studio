...
- מתחת ל־1024px ההגדרות הופכות למגירת צד מודאלית; ב־680px ומטה הן הופכות למסך מלא עם סעיפי אקורדיון.
- ב־680px ומטה ברירת המחדל היא תצוגת שבוע מותאמת למגע ובה בדיוק שבעה כרטיסי יום ופקדי ניווט בגודל 48px.
- סרגל תחתון קבוע ומודע ל־safe areas מספק הגדרות, שבוע קריא, דף מלא וייצוא PDF.
- בטלפון אופקי ברוחב 600–680px כרטיסי הימים מוצגים בשתי עמודות.
